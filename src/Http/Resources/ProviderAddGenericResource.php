...
use Finance, Bank;
/**
 * Class ProviderAddGenericResource
 *
 * @package MotoboyApp
 *
 *
 * @OA\Schema(
 *         schema="ProviderAddGenericResource",
 *         type="object",
 *         description="Adiciona um saque para o prestador",
 *         title="Generic Details Resource",
 *        allOf={
 *           @OA\Schema(ref="#/components/schemas/ProviderAddGenericResource"),
 *           @OA\Schema(
 ...
 * )
 */
class ProviderAddGenericResource extends JsonResource {
